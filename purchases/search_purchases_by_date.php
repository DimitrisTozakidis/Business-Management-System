...
<html lang="en">
	...
	<head>
		...
		<link rel="stylesheet" href="search_purchases_by_date.css">
		...
		<div class="container">		
			...
			<nav class="navbar navbar-light bg-light">
				<form class="form-inline" method="post">
					<input class="form-control mr-sm-2" type="date" placeholder="Enter purchase's date" aria-label="Search"  name="field">
			...
			<table class="table">
				...
				<tbody>
					<?php 
						//με το πάτημα του κουμπιού search, αναζητούμε το στοιχείο με βάση την ημερομηνία που επιλέξαμε.
						if(isset($_POST['search'])){	
							$date = $_POST['field'];
							$sql = "Select * from `purchases` where DATE ='$date'";
