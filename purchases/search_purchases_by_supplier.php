...
<html lang="en">
	...
	<head>
		...
		<link rel="stylesheet" href="search_purchases_by_supplier.css">
		...
		<div class="container">		
			...
			<nav class="navbar navbar-light bg-light">
				<form class="form-inline" method="post">
					<input class="form-control mr-sm-2" type="search" placeholder="Enter purchase's supplier" aria-label="Search"  name="field">
			...
			<table class="table">
				...
				<tbody>
					<?php
						//με το πάτημα του κουμπιού search, αναζητούμε στα τιμολογία αγορών με βάση τον προμηθευτή.
						if(isset($_POST['search'])){	
							$supplier = $_POST['field'];
							...
							if($supplier == '*'){
								...
								$sql = "Select * from `purchases` where SUPPLIER LIKE '$supplier%'";
							}
