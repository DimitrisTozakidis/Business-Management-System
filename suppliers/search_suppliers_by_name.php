...
<html lang="en">
	...
	<head>
		...
		<link rel="stylesheet" href="search_suppliers_by_name.css">
		...
		<div class="container">
			...
			<nav class="navbar navbar-light bg-light">
				<form class="form-inline" method="post">
					<input class="form-control mr-sm-2" type="search" placeholder="Enter supplier's name" aria-label="Search"  name="field">
				...
				<tbody>
					<?php 
						...
						if(isset($_POST['search'])){
							$name = $_POST['field'];
							$sql = "Select * from `suppliers` where COMPANY_NAME LIKE '$name%'";
