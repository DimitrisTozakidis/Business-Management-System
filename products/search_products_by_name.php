...
<html lang="en">
	...
	<head>
		...
		<link rel="stylesheet" href="search_products_by_name.css">
		...
		<div class="container">		
			...
			<nav class="navbar navbar-light bg-light">
				<form class="form-inline" method="post">
					<input class="form-control mr-sm-2" type="search" placeholder="Enter product's name" aria-label="Search"  name="field">
