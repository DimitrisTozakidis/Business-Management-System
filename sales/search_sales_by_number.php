...
<html lang="en">
	...
	<head>
		...
		<link rel="stylesheet" href="search_sales_by_number.css">
		<title>Sales</title>
	</head>
		...
		<div class="container">		
			...
			<nav class="navbar navbar-light bg-light">
				<form class="form-inline" method="post">
					<input class="form-control mr-sm-2" type="search" placeholder="Enter sales's number" aria-label="Search"  name="field">
					...
					<?php
						...
						if(isset($_POST['search'])){	
							...
							if($number == '*' || $number == '0'){
								...
								$sql = "Select * from `sales` where number='$number'";
							}
