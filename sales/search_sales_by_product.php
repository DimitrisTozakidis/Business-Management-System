...
<html lang="en">
	...
	<head>
		...
		<link rel="stylesheet" href="search_sales_by_product.css">
		<title>Sales</title>
	</head>
		...
		<div class="container">		
			...
			<nav class="navbar navbar-light bg-light">
				<form class="form-inline" method="post">
					<input class="form-control mr-sm-2" type="search" placeholder="Enter sale's product" aria-label="Search"  name="field">
					...
					<?php
						...
						if(isset($_POST['search'])){	
							...
							if($product == '*'){
								...
								$sql = "Select * from `sales` where PRODUCT LIKE '$product%'";
							}
