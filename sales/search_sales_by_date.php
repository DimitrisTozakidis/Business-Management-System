...
<html lang="en">
	...
	<head>
		...
		<link rel="stylesheet" href="search_sales_by_date.css">
		<title>Sales</title>
	</head>
		...
		<div class="container">		
			...
			<nav class="navbar navbar-light bg-light">
				<form class="form-inline" method="post">
					<input class="form-control mr-sm-2" type="date" placeholder="Enter sales's date" aria-label="Search"  name="field">
